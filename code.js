...
// 	// eval('MoveMasterSidebar.'+game.user.data._id+' = new SidebarForm({ classes: "ptu-sidebar"})');
// 	// eval('MoveMasterSidebar.'+game.user.data._id+'.render(true)');
// 	ui.sidebar.render();
// });


Hooks.on("ptu.moveUsed", async (actor, item) => {
		...
		if(item.name.includes(searched_move))
		{
			if(custom_moves[searched_move]["roll-trigger"] != null) // Effect Range Check
			{
				...
				if(diceRoll >= (effectThreshold - effect_range_bonus)) // Effect Range Hit
				{
					...
					{
						await SetCurrentWeather(custom_moves[searched_move]["weather"]);
					}
			...
			if(item.name.includes(searched_move))
			{
				if(move_stage_changes[searched_move]["roll-trigger"] != null) // Effect Range Check
				{
					...
					if(diceRoll >= (effectThreshold - effect_range_bonus)) // Effect Range Hit
					{
						...
						{
							await SetCurrentWeather(move_stage_changes[searched_move]["weather"]);
						}
...
// 		await ResetActionEconomy(current_actor, true);
// 	}
// });
...
// 			await ResetStagesToDefault(current_actor, true);
// 			await ResetActionEconomy(current_actor, true);
// 			await resetEOTMoves(current_actor, true);
// 			await resetSceneMoves(current_actor, true);

// 			// for(let affliction of VolatileAfflictions)
// 			// {
// 			// 	await cureActorAffliction(current_actor, affliction, true);
// 			// }
// 			await cureActorAffliction(current_actor, "Fainted", true);


// 			}
// 			await AudioHelper.play({src: GetSoundDirectory()+stat_down_sound_file, volume: 0.5, autoplay: true, loop: false}, true);
// 		},
// 		defaultYes: false 
// 	})
//     }
...
// 		let new_actor = GetActorFromToken(new_token);
...
// 	ui.sidebar.render();
// 	MoveMasterSidebar = new SidebarForm({ classes: "ptu-sidebar"});
// 	MoveMasterSidebar.render(true);

// });

// Hooks.on("renderChatMessage", (message, html, data) => {
//     setTimeout( async () => {
// 		$(html).find(".skill-button-1").click("click", function(){RollSkillCheck(
// 			this.dataset.skill
// 		)});
// 		$(html).find(".skill-button-2").click("click", function(){RollSkillCheck(
// 			this.dataset.skill
// 		)});
// 		$(html).find(".skill-button-both").click("click", function(){RollSkillCheck(
...
// 		{
// 			chatMessage(current_actor, current_actor.name+" is fainted - automatically skipping to next turn.");
// 			await TakeAction(current_actor, "Standard");
// 			await TakeAction(current_actor, "Standard");
// 			setTimeout( async () => {  
...
// 			{
// 				chatMessage(current_actor, current_actor.name+" is frozen - automatically skipping to end of turn.");
// 				await TakeAction(current_actor, "Standard");
// 				await TakeAction(current_actor, "Standard");
// 				setTimeout( async () => {  
// 					game.combat.nextTurn();
...
// 			{
// 				chatMessage(current_actor, current_actor.name+" is asleep - automatically skipping to end of turn.");
// 				await TakeAction(current_actor, "Standard");
// 				await TakeAction(current_actor, "Standard");
// 				setTimeout( async () => {  
// 					game.combat.nextTurn();
...
// 	if(ActorHasItemWithName(current_actor, "Ice Body", "ability"))
// 	{
// 		actor_immune_to_hail = true;
// 		actor_heals_from_hail = true;
// 	}

// 	if(ActorHasItemWithName(current_actor, "Ice Body [Playtest]", "ability"))
// 	{
// 		actor_immune_to_hail = true;
// 	}

// 	// if(ActorHasItemWithName(current_actor, "HEAL FROM SANDSTORM", "ability"))
// 	// {
// 	// 	actor_immune_to_sandstorm = true;
...
// 	if(ActorHasItemWithName(current_actor, "Snow Cloak", "ability"))
// 	{
// 		actor_immune_to_hail = true;
// 	}

// 	if(ActorHasItemWithName(current_actor, "Overcoat", "ability"))
// 	{
// 		actor_immune_to_hail = true;
// 		actor_immune_to_sandstorm = true;
...
// 	if(ActorHasItemWithName(current_actor, "Snow Warning", "ability"))
// 	{
// 		actor_immune_to_hail = true;
// 	}

// 	if(ActorHasItemWithName(current_actor, "Arctic Pilgrim - Tundra Terrain", "feat"))
// 	{
// 		actor_immune_to_hail = true;
// 	}

// 	if(ActorHasItemWithName(current_actor, "The Cold Never Bothered Me Anyway", "feat"))
// 	{
// 		actor_immune_to_hail = true;
// 	}


// 	if(ActorHasItemWithName(current_actor, "Dune Walker - Desert Terrain", "feat"))
// 	{
// 		actor_immune_to_sandstorm = true;
// 	}

// 	if(ActorHasItemWithName(current_actor, "Desert Weather", "ability"))
// 	{
// 		actor_immune_to_sandstorm = true;
// 	}

// 	if(ActorHasItemWithName(current_actor, "Sand Force", "ability"))
// 	{
// 		actor_immune_to_sandstorm = true;
// 	}

// 	if(ActorHasItemWithName(current_actor, "Sand Rush", "ability"))
// 	{
// 		actor_immune_to_sandstorm = true;
// 	}

// 	if(ActorHasItemWithName(current_actor, "Sand Stream", "ability"))
// 	{
// 		actor_immune_to_sandstorm = true;
// 	}

// 	if(ActorHasItemWithName(current_actor, "Sand Veil", "ability"))
// 	{
// 		actor_immune_to_sandstorm = true;
// 	}
...
// 	if(ActorHasItemWithName(current_actor, "Magic Guard", "ability"))
// 	{
// 		actor_is_immune_to_weather_ticks = true;
// 	}

// 	if(ActorHasItemWithName(current_actor, "Permafrost [Playtest]", "ability"))
// 	{
// 		actor_is_immune_to_weather_ticks = true;
// 	}
...
// 			{
// 				damageActorTick(current_actor, "Sandstorm");
// 			}
// 			else if(actor_heals_from_sandstorm)
// 			{
// 				healActorTick(current_actor, "Sandstorm");
// 			}
// 			else
// 			{
// 				chatMessage(current_actor, current_actor.name + ' is immune to the Sandstorm\'s effects!');
// 			}
// 		}
...
// 			{
// 				damageActorTick(current_actor, "Hail");
// 			}
// 			else if(actor_heals_from_hail)
// 			{
// 				healActorTick(current_actor, "Hail");
// 			}
// 			else
// 			{
// 				chatMessage(current_actor, current_actor.name + ' is immune to the Hail\'s effects!');
// 			}
// 		}

// 		if(currentWeather == "Rainy")
// 		{
// 			if(ActorHasItemWithName(current_actor, "Rain Dish", "ability"))
// 			{
// 				healActorTick(current_actor, "Rainy + Rain Dish");
// 			}

// 			if(ActorHasItemWithName(current_actor, "Dry Skin", "ability"))
// 			{
// 				healActorTick(current_actor, "Rainy + Dry Skin");
// 			}
// 		}
...
// 			if(ActorHasItemWithName(current_actor, "Dry Skin", "ability"))
// 			{
// 				damageActorTick(current_actor, "Sunny + Dry Skin");
// 			}

// 			if(ActorHasItemWithName(current_actor, "Sun Blanket", "ability"))
// 			{
// 				healActorTick(current_actor, "Sunny + Sun Blanket");
// 			}
// 		}
...
// 		else
// 		{
// 			MoveMasterSidebar = await new SidebarForm({ classes: "ptu-sidebar"});
// 			await MoveMasterSidebar.render(true);
...
// 			{
// 				TakeAction(current_actor, "Shift");
// 				setTimeout( async () => { 
...
// 						await AudioHelper.play({src: GetSoundDirectory()+"pokeball_sounds/"+"pokeball_miss.mp3", volume: 0.5, autoplay: true, loop: false}, true);
...
// 						setTimeout( async () => { 
// 							await AudioHelper.play({src: GetSoundDirectory()+"pokeball_sounds/"+"pokeball_release.mp3", volume: 0.5, autoplay: true, loop: false}, true); 
// 						}, 500);
// 					}
// 				}
...
// 		let item_art = await GetItemArt(dropped_item.name);
...
// 	{
// 		let item_art = await GetItemArt(new_item.name);
...
export function PTUAutoFight()
{
	...
	async function ApplyDamage(event)
	{
		...
		if (key_shift) 
		{
			let form = new MoveMasterBonusDamageReductionOptions({event}, {"submitOnChange": false, "submitOnClose": true});
			form.render(true);
		}
		else
		{
			...
			for(let token of canvas.tokens.controlled)
			{
				...
				if(token.actor.data.flags.ptu)
				{
					...
					{
						cureActorAffliction(token.actor, "Frozen");
					}
				
					if( token.actor.data.flags.ptu.is_sleeping || token.actor.data.flags.ptu.is_badly_sleeping )
					{
						cureActorAffliction(token.actor, "Sleep");
						cureActorAffliction(token.actor, "BadSleep");
					}
				}
			...
			await AudioHelper.play({src: GetSoundDirectory()+damageSoundFile, volume: 0.8, autoplay: true, loop: false}, true);
		}
	...
	async function ChatWindow(actor, silent=false)
	{
		if(!silent)
		{
			await AudioHelper.play({src: GetSoundDirectory()+UIPopupSound, volume: 0.5, autoplay: true, loop: false}, false);
		}

		let target = Array.from(game.user.targets)[0];
		let targetTypingText = GetTargetTypingHeader(target, actor)
		let background_field_URL = await GetCurrentFieldImageURL();
		...
		var typeStrategist = [];
		var technician = ActorHasItemWithName(actor, "Technician", "ability");
		var hasPokedex = false;
		if(actor.type == "character")
		{
			hasPokedex = ActorHasItemWithName(actor, "Pokedex", "item");
		}
		else
		{
			if(actor.data.data.owner!= "0")
			{
				hasPokedex = ActorHasItemWithName( (game.actors.get(actor.data.data.owner)), "Pokedex", "item");
			}
		}
		...
		buttons["skillsMenu"] = {noRefresh: true, id:"skillsMenu", label: "<div class='skillsMenu' style='background-image:url("+AlternateIconPath+"NewPokedex_Vertical_CenterScreen_200.png"+"); height:20px; font-size:16px;font-family:Modesto Condensed;line-height:1.2'>"+"Skills"+menu_image_backdrop_image+"</div>",
			callback: async () => {
				await ShowSkillsMenu(actor);
				await AudioHelper.play({src: GetSoundDirectory()+UIPopupSound, volume: 0.8, autoplay: true, loop: false}, false);
			}};
		...
		if(actor.data.type == "character")
		{
			...
			// 		await PokedexScan(actor_token, target);
			// 	}};
			// }
			// else
			// {
			...
			// 		await AudioHelper.play({src: GetSoundDirectory()+"warning.wav", volume: 0.5, autoplay: true, loop: false}, true);
			// }};
			// }
		...
		else if(actor.data.data.owner!= "0")
		{
			...
			else
			{
				...
				callback: async () => {
					...
					await AudioHelper.play({src: GetSoundDirectory()+"warning.wav", volume: 0.5, autoplay: true, loop: false}, false);
				}};
			}
		}
		else
		...
		if(actor.data.type == "character")
		{
			...
			for(let order of orders_list)
			{
				...
				if(ActorHasItemWithName(actor, order, "feat"))
				{
					...
					if(pokemon_order_state == "off")
					{
						buttons[button_string] = 
						{
							...
							callback: async () => 
							{
								await ApplyTrainingToActorsActivePokemon(actor, order, "off", active_pokemon_list);
								await AudioHelper.play({src: GetSoundDirectory()+UIButtonClickSound, volume: 0.5, autoplay: true, loop: false}, true);
								await TakeAction(actor, "Standard")
							}
						};
					}
					else
					{
						buttons[button_string] = 
						{
							...
							callback: async () => 
							{
								await ApplyTrainingToActorsActivePokemon(actor, order, "on", active_pokemon_list);
								await AudioHelper.play({src: GetSoundDirectory()+UIButtonClickSound, volume: 0.5, autoplay: true, loop: false}, true);
								await TakeAction(actor, "Standard")
							}
						};
					...
					is_auto_active = await ActorGetAutoOrderState(actor, order);
					...
					if(is_auto_active)
					{
						...
						buttons[on_button_string] = 
						{
							...
							{
								// await AudioHelper.play({src: GetSoundDirectory()+UIButtonClickSound, volume: 0.5, autoplay: true, loop: false}, true);
								await ActorSetAutoOrders(actor, order, false);
							}
						};
					}
					else
					{
						...
						buttons[off_button_string] = 
						{
							...
							{
								// await AudioHelper.play({src: GetSoundDirectory()+UIButtonClickSound, volume: 0.5, autoplay: true, loop: false}, true);
								await ActorSetAutoOrders(actor, order, true);
							}
						};
					}
				}
		...
		if((actor.data.data.heldItem) && (actor.data.data.heldItem.toLowerCase() != "none") && (actor.data.data.heldItem.toLowerCase() != "") )
		{
			...
			let heldItem_item_icon = await GetItemArt(heldItem);
		...
		if(actor.data.data.digestionBuff)
		{
			...
			let disgestion_item_icon = await GetItemArt(digestionBuff);
			...
			buttons["digestionBuff"] = 
			{
				...
				callback: async () => 
				{
					await ActivateDigestionBuff(actor, digestionBuff, digestionBuffState);
					await AudioHelper.play({src: GetSoundDirectory()+UIButtonClickSound, volume: 0.5, autoplay: true, loop: false}, true);
				}
			};
		}
		...
		for(let item of items) // START STATUS MOVE LOOP
		{
			...
			if(target)
			{
				...
				{
					actor_has_target_dex_entry = ThisActorOrTheirTrainerHasDexEntry(actor, target.actor.data.data.species);
					if(game.user.isGM)
					{
			...
			if(currenttype=="move" && (currentCategory == "Status"))
			{
				...
				let rangeIconReturn = GetRangeIcons(item_data.range, move_action);
				...
				buttons[currentid]={
					...
					callback: async () => {
						...
						{
							chatMessage(actor, "But they did not obey!")
							return;
						}
						let key_shift = game.keyboard.downKeys.has("ShiftLeft");
			...
			if(currenttype=="move" && (currentCategory == "Physical" || currentCategory == "Special"))
			{
				...
				buttons[currentid]={
					...
					callback: async () => {
							...
							{
								await RollDamageMove(actor, item, item.name, finalDB, typeStrategist, 0);
							}
						}
		...
		let sidebar = new SidebarForm({content, buttons, dialogueID, classes: "ptu-sidebar"});
	...
	{
		let form = new MoveMasterBonusDamageOptions({actor , item, finalDB, typeStrategist}, {"submitOnChange": false, "submitOnClose": false});
		form.render(true);
	}

	async function PokedexScanButton(event)
	{
		PokedexScan(event.currentTarget.dataset.trainer_token, event.currentTarget.dataset.tarket_pokemon_token);
	}
...
export async function ResetStagesToDefault(actor, silent=false)
{
	...
	if(!silent)
	{
		chatMessage(actor, actor.name + " All Stages Reset!");
		await AudioHelper.play({src: GetSoundDirectory()+"Stat%20Fall%20Down.mp3", volume: 0.5, autoplay: true, loop: false}, true);
	}
}
...
export async function RollDamageMove(actor, item_initial, moveName, finalDB, typeStrategist, bonusDamage)
	{
		...
		var item_entities=actor.items;
		let diceRoll = await PerformFullAttack (actor, item, moveName, finalDB, bonusDamage);
...
export async function adjustActorStage(actor, stat, change)
{
	setTimeout( async () => {
		...
		let AE_changes = [];
		let is_simple = ActorHasItemWithName(actor, "Simple", "ability");
		...
		effects.forEach((value, key, map) => {	// We check if there are any Active Effects changing the stat and offset them to avoid weird results.
			...
			{
				if(change.key == eval("'data.stats."+stat+".stage.value'"))
				{
		...
		if(change > 0)
		{
			await AudioHelper.play({src: GetSoundDirectory()+stat_up_sound_file, volume: 0.8, autoplay: true, loop: false}, true);
		}
		else
		{
			await AudioHelper.play({src: GetSoundDirectory()+stat_down_sound_file, volume: 0.8, autoplay: true, loop: false}, true);
		}

		let old_stage = eval("(Number(actor.data.data.stats."+stat+".stage.value))");
		old_stage -= stage_AE_sum;

		let new_stage = eval("Math.max(Math.min((old_stage + Number(change)), 6), -6)");

		eval("actor.update({'data.stats."+stat+".stage.value': Number("+ new_stage +") })");
		...
		if(is_simple)
		{
			setTimeout( async () => {  
				...
				eval("actor.update({'data.stats."+stat+".stage.value': Number("+ new_stage +") })");
				chatMessage(actor, actor.name + ' '+ stat +' Stage +'+ change +' again, due to Simple!');
			}, 1000);
		}
	}, 100);
}
...
export async function healActorPercent(actor,pct_healing)
{
	...
	await AudioHelper.play({src: GetSoundDirectory()+heal_sound_file, volume: 0.8, autoplay: true, loop: false}, true);
...
export async function healActor(actor, healing_amount)
{
	...
	actor.modifyTokenAttribute("health", (final_healing_amount), true, true);
	chatMessage(actor, actor.name + ' healed '+ final_healing_amount +' hit points!');
}
...
export async function setActorHealth(actor, new_health)
{
	...
	chatMessage(actor, actor.name + '\'s health was set to '+ new_health +' hit points!');
}
...
export async function setActorHealthPercent(actor, new_health_percent) // Percent expressed as fractions of 1. 30% would be 0.3, etc.
{
	...
	chatMessage(actor, actor.name + '\'s health was set to '+ new_health_percent*100 +'% of their max hit points!');
}


export async function damageActorPercent(actor,pct_damage)
{
	await AudioHelper.play({src: GetSoundDirectory()+damage_sound_file, volume: 0.8, autoplay: true, loop: false}, true);
...
export async function damageActorFlatValue(actor, damage_value, source="")
{
	...
	actor.modifyTokenAttribute("health", -finalDamage, true, true);
	chatMessage(actor, actor.name + ' lost '+ finalDamage +' Hit Points'+source_string+'!');
	ApplyInjuries(actor, finalDamage);
}
...
export async function damageActorTick(actor, source="", tick_count=1)
{
	...
	if(ActorHasItemWithName(actor, "Permafrost", "ability"))
	{
		tick_DR += 5;
		tick_DR_flavor = ", after "+tick_DR+" Tick DR from Permafrost";
	}

	if(PokemonsTrainerHasItemWithName(actor, "Stat Mastery (Special Defense)", "feat"))
	{
		tick_DR += 5;
	...
	await chatMessage(actor, actor.name + ' took '+tick_count+' tick of damage ('+ finalDamage +' Hit Points)'+source_string+tick_DR_flavor+'!');
	await ApplyInjuries(actor, finalDamage);
}
...
export async function healActorTick(actor, source="")
{
	...
	await chatMessage(actor, actor.name + ' healed a tick of damage ('+ finalhealing +' Hit Points)'+source_string+'!');
}
...
export async function healActorRest(actor, hours=8, bandage_used=false, pokecenter=false)
{
	...
	{
		await resetEOTMoves(actor, true);
		await resetSceneMoves(actor, true);
		await resetDailyMoves(actor, true);
	...
	setTimeout( async () => {  
		...
		await actor.modifyTokenAttribute("health", finalhealing, true, true);
		await chatMessage(actor, actor.name + ' rested for '+hours+' hours'+pokecenter_text+', healing '+ finalhealing +' Hit Points and '+injuries_healed+' injuries!'+injury_gtr_5_text);
	}, 1000);
}
...
{
	let form = new MoveMasterRestHoursOptions({actor}, {"submitOnChange": false, "submitOnClose": false});
	form.render(true);
}
...
export async function cureActorAffliction(actor, affliction_name, silent=false)
{
	...
	if(actor.data.flags.ptu)
	{
		if(eval('actor.data.flags.ptu.'+lowercase_affliction_name) == "true")
		{
			...
			if(!silent)
			{
				await chatMessage(actor, actor.name + ' was cured of '+ affliction_name +'!');
			}
...
export async function PerformFullAttack (actor, move, moveName, finalDB, bonusDamage) 
{
	...
	if(target_token)
	{
		target_actor = GetActorFromToken(target_token);
	}
	...
	let acRoll = await CalculateAcRoll(move, actor.data);
	let diceResult = await GetDiceResult(acRoll);

	let acRoll2 = await CalculateAcRoll(move, actor.data);
	let diceResult2 = await GetDiceResult(acRoll2);
	...
	let damageRoll = await CalculateDmgRoll(move, actor.data.data, 'normal', userHasTechnician, userHasAdaptability, isDoubleStrike, isFiveStrike, fiveStrikeCount, 1, 0, bonusDamage);
	if(damageRoll) 
	{
		await damageRoll.roll();
	}
	let critDamageRoll = await CalculateDmgRoll(move, actor.data.data, 'hit', userHasTechnician, userHasAdaptability, isDoubleStrike, isFiveStrike, fiveStrikeCount, 1, 0, bonusDamage);
	if(!move.name)
	{
		move.name=move.name;
	}
	...
	let damageRollTwoHits = await CalculateDmgRoll(move, actor.data.data, 'normal', userHasTechnician, userHasAdaptability, isDoubleStrike, isFiveStrike, fiveStrikeCount, 2, 0, bonusDamage);
	if(damageRollTwoHits)
	{
		await damageRollTwoHits.roll();
	}

	let critDamageRollOneHitOneCrit = await CalculateDmgRoll(move, actor.data.data, 'hit', userHasTechnician, userHasAdaptability, isDoubleStrike, isFiveStrike, fiveStrikeCount, 2, 1, bonusDamage);
	if(critDamageRollOneHitOneCrit)
	{
		await critDamageRollOneHitOneCrit.roll();
	}

	let critDamageRollTwoCrits = await CalculateDmgRoll(move, actor.data.data, 'hit', userHasTechnician, userHasAdaptability, isDoubleStrike, isFiveStrike, fiveStrikeCount, 2, 2, bonusDamage);
	...
	setTimeout( async () => { 
		await sendMoveRollMessage(moveName, acRoll, acRoll2, {
	...
	await AudioHelper.play({src: GetSoundDirectory()+moveSoundFile, volume: 0.8, autoplay: true, loop: false}, true);
	...
	{
		await TakeAction(actor, "Full", move.category);
	}
	else if(move.name == "Splash")
	{
		await TakeAction(actor, "Shift", move.category);
	}
	else
	{
		await TakeAction(actor, "Standard", move.category);
	}
	...
	if(targeted && !move.range.includes("Self") && !move.range.includes("Blessing") && !move.range.includes("Field"))
	{
		...
		else // Hit! Play hit animation on target.
		{
			...
			// await AudioHelper.play({src: GetSoundDirectory()+"pokeball_sounds/"+"pokeball_hit.mp3", volume: 0.5, autoplay: true, loop: false}, true);
...
// 			{
// 				injuryCount++;
// 				await chatMessage(target, target.name + " suffered massive damage and sustains an injury!");
// 			}

// 			if( (final_effective_damage >= 1) && (targetHealthCurrent > hitPoints50Pct) && ((targetHealthCurrent - final_effective_damage) <= hitPoints50Pct) )
// 			{
// 				injuryCount++;
// 				await chatMessage(target, target.name + " was damaged to below the 50% health threshold and sustains an injury!");
// 			}

// 			if( (final_effective_damage >= 1) && (targetHealthCurrent > hitPoints0Pct) && ((targetHealthCurrent - final_effective_damage) <= hitPoints0Pct) )
// 			{
// 				injuryCount++;
// 				await chatMessage(target, target.name + " was damaged to below the 0% health threshold and sustains an injury! "+target.name+" has *fainted*!");
// 			}
...
// 			{
// 				injuryCount++;
// 				await chatMessage(target, target.name + " was damaged to below the -100% health threshold and sustains an injury!");
// 			}
...
// 			{
// 				injuryCount++;
// 				await chatMessage(target, target.name + " was damaged to below the -150% health threshold and sustains an injury!");
// 			}
...
// 			{
// 				injuryCount++;
// 				await chatMessage(target, target.name + " was damaged to below the -200% health threshold and sustains an injury! If using death rules, "+target.name+" *dies*!");
// 			}

// 			await target.update({'data.health.injuries': Number(target.data.data.health.injuries + injuryCount) });
// 			if(injuryCount)
// 			{
// 				await injuryTokenSplash(target);
// 			}
// 		}
...
// 			yes: async () => {
// 				await enableCondition(target, "fainted", "other");
// 			},
// 			defaultYes: false 
// 		})
// 	}
...
// {
// 	let throwing_actor = GetActorFromToken(actor_token);

// 	let throwRange = throwing_actor.data.data.capabilities["Throwing Range"];

// 	let trainerHasThrowingMasteries = ActorHasItemWithName(throwing_actor, "Throwing Masteries", "edge");
...
// 	let trainerHasToolsOfTheTrade = ActorHasItemWithName(throwing_actor, "Tools of the Trade", "feat")
...
// 		{
// 			trainer_token = GetTokenFromActor(game.actors.get(currently_selected_token.actor.data.data.owner));
// 		}
// 	}
...
// 	// 	{
// 	// 		if(!ActorHasItemWithName(current_actor_to_add_DEX_entry_for, target_pokemon_actor.data.data.species, "dexentry"))
// 	// 		{
...
// 	await AudioHelper.play({src: GetSoundDirectory()+"pokedex_ding.wav", volume: 0.5, autoplay: true, loop: false}, true);
// 	setTimeout( async () => {  SpeakPokemonName(target_pokemon_actor); }, 800);
// 	// target_pokemon_token.update
// 	await TakeAction(trainer_actor, "Standard");
...
// 	await AudioHelper.play({src: GetSoundDirectory()+"pokeball_sounds/"+"pokeball_catch_attempt.mp3", volume: 0.5, autoplay: true, loop: false}, true);

// 	setTimeout( async () => {  
// 		chatMessage(target, ("Pokeball hit! The ball wiggles..."));
// 		// ui.notifications.info(`The ball wiggles!`);
// 		await AudioHelper.play({src: GetSoundDirectory()+"pokeball_sounds/"+"pokeball_escape_attempt.mp3", volume: 1.0, autoplay: true, loop: false}, true);
		
// 		setTimeout( async () => {  
// 			await roll.toMessage();
// 			if(Number(roll._total) <= CaptureRate)
// 			{
// 				await AudioHelper.play({src: GetSoundDirectory()+"pokeball_sounds/"+"pokeball_catch_confirmed.mp3", volume: 0.8, autoplay: true, loop: false}, true);
...
// 				setTimeout( async () => {  
// 					await AudioHelper.play({src: GetSoundDirectory()+"pokeball_sounds/"+"pokeball_success_jingle.wav", volume: 0.8, autoplay: true, loop: false}, true);
// 				}, 750);

// 				RemoveThrownPokeball(trainer, pokeball_item);
...
// 				BreakPokeball(trainer, pokeball_item);
// 			}
// 		}, 8000);
// 	}, 4000);
// };
...
// 	await AudioHelper.play({src: GetSoundDirectory()+UIPopupSound, volume: 0.8, autoplay: true, loop: false}, false);
// 	await AudioHelper.play({src: GetSoundDirectory()+"pokeball_sounds/pokeball_grow.mp3", volume: 0.8, autoplay: true, loop: false}, false);
...
// 				if(await IsWithinPokeballThrowRange(actor_token, target_pokemon_token, pokeball.name))
// 				{
// 					if(await ExpendItem(actor, pokeball))
// 					{
// 						await ThrowPokeball(actor_token, target_pokemon_token, pokeball.name, pokeball);
// 					}
// 					else
// 					{
// 						await AudioHelper.play({src: GetSoundDirectory()+"warning.wav", volume: 0.5, autoplay: true, loop: false}, true);
...
// 	{
// 		let item_base_image = await GetItemArt(inventory_item.name);
// 		let item_image = "";
...
// 				{
// 					await UseInventoryItem(actor_token, target, inventory_item.name);
// 				}
// 				else
// 				{
// 					await AudioHelper.play({src: GetSoundDirectory()+"warning.wav", volume: 0.5, autoplay: true, loop: false}, true);
...
// 		let rangeIconReturn = GetRangeIcons(currentRange);
// 		let currentMoveRange = rangeIconReturn[0];
...
// 				let command_check_result = await ThisPokemonsTrainerCommandCheck(this_actor);
// 				if(!command_check_result)
// 				{
// 					chatMessage(this_actor, "But they did not obey!")
// 					return;
// 				}
// 				let key_shift = game.keyboard.downKeys.has("ShiftLeft");
// 				if (key_shift) 
// 				{
// 					rollDamageMoveWithBonus(this_actor , created_move_item, maneuver, finalDB, false);
// 				}
// 				else
// 				{
// 					RollDamageMove(this_actor, created_move_item, maneuver, finalDB, false, 0);
// 				}
...
// 					// 	  for(let combatant of combatants)
// 					// 	  {
// 					// 		await ResetStagesToDefault(combatant.actor);
// 					// 	  }
// 					// 	},
// 					// 	defaultYes: false 
// 					//   })
// 					ResetStagesToDefault(actor);
// 					for(let affliction of VolatileAfflictions)
// 					{
// 						await cureActorAffliction(actor, affliction);
// 					}
...
// 		<img class='pokedex-bottom' src='"+AlternateIconPath+"NewPokedex_Vertical_Bottom_200.png"+"'></img>\
// 		<center><img class='pokedex-bottom-weather' title='Current Weather: "+current_weather+"' src='"+AlternateIconPath+weather_icon+"'></img></center>";
// 	MoveMasterSidebar = new SidebarForm({content, buttons: maneuver_buttons, dialogueID, classes: "ptu-sidebar"});
// 	MoveMasterSidebar.render(true);
...
// 		<img class='pokedex-bottom' src='"+AlternateIconPath+"NewPokedex_Vertical_Bottom_200.png"+"'></img>\
// 		<center><img class='pokedex-bottom-weather' title='Current Weather: "+current_weather+"' src='"+AlternateIconPath+weather_icon+"'></img></center>";
// 	MoveMasterSidebar = new SidebarForm({content, buttons: skill_buttons, dialogueID, classes: "ptu-sidebar"});
// 	MoveMasterSidebar.render(true);
// }
...
// 				if (key_shift) 
// 				{
// 					await rollDamageMoveWithBonus(this_actor , created_move_item, struggle, finalDB, false);
// 				}
// 				else
// 				{
// 					await RollDamageMove(this_actor, created_move_item, struggle, finalDB, false, 0);
// 				}
...
// 	MoveMasterSidebar = new SidebarForm({content, buttons: struggle_buttons, dialogueID, classes: "ptu-sidebar"});
// 	MoveMasterSidebar.render(true);
// }
...
export async function UseInventoryItem(actor_token, target_token, inventory_item)
{
	...
	{
		healActor(target_token.actor, item_properties[inventory_item]["healing"]);
	}

	if(item_properties[inventory_item]["set_hitpoint_to"])
	{
		setActorHealth(target_token.actor, item_properties[inventory_item]["set_hitpoint_to"]);
	}

	if(item_properties[inventory_item]["set_hitpoint_to_pct"])
	{
		healActor(target_token.actor, item_properties[inventory_item]["set_hitpoint_to_pct"]);
	}
	...
	if(item_properties[inventory_item]["condition_cure"])
	{
		if(item_properties[inventory_item]["condition_cure"].length > 0)
		{
			...
			{
				await cureActorAffliction(target_token.actor, affliction);
			}
			await AudioHelper.play({src: GetSoundDirectory()+heal_sound_file, volume: 0.8, autoplay: true, loop: false}, true);
		}
	}
	...
	setTimeout( async () => {  TakeAction(actor_token.actor, "Standard"); }, 1000);
}
...
// 	let showEffectivenessMode = game.settings.get("PTUMoveMaster", "showEffectiveness");
// 	let actions_image = GetActorActionIcon(actor);
// 	let actions_image_target = "";
// 	if(target)
// 	{
// 		actions_image_target = GetActorActionIcon(target.actor, true);
// 	}
...
{
	let currentWeather = game.settings.get("ptu", "currentWeather");
...
{
	let current_weather = game.settings.get("ptu", "currentWeather");
	...
	{
		game.settings.set("ptu", "currentWeather", new_weather);
...
export async function resetEOTMoves(actor, silent=false)
{
	...
	if(!silent)
	{
		...
		await AudioHelper.play({src: GetSoundDirectory()+RefreshEOTMovesSound, volume: 0.8, autoplay: true, loop: false}, true);
	}
}
...
export async function resetSceneMoves(actor, silent=false)
{
	...
	if(!silent)
	{
		...
		await AudioHelper.play({src: GetSoundDirectory()+RefreshSceneMovesSound, volume: 0.8, autoplay: true, loop: false}, true);
	}
}
...
export async function resetDailyMoves(actor, silent=false)
{
	...
	if(!silent)
	{
		...
		await AudioHelper.play({src: GetSoundDirectory()+RefreshDailyMovesSound, volume: 0.8, autoplay: true, loop: false}, true);
	}
}
...
export async function enableCondition(target_actor, condition, condition_type = "other") // TODO: Implement
{
	...
	if(condition == "fainted")
	{
		...
		{
			await cureActorAffliction(target_actor, affliction);
		}
	}
}
...
export async function GetCurrentFieldImageURL()
{
	...
	let current_weather = await GetCurrentWeather();
...
export async function adjustActorAccuracy(actor, change)
{
	setTimeout( async () => {
		...
		chatMessage(actor, actor.name + ' Accuracy +'+ change +'!');
...
// 	{
// 		if(ActorHasItemWithName(actor, species_name.toLowerCase(), "dexentry"))
// 		{
// 			return_value = true;
// 		}
// 	}
...
// 		if(actors_trainer)
// 		{
// 			if(ActorHasItemWithName(actors_trainer, species_name.toLowerCase(), "dexentry"))
// 			{
// 				return_value = true;
// 			}
// 		}
...
// 			{
// 				cureActorAffliction(actor, digestionsBuffs[digestionBuff][liked_disliked_neutral][effect], false);
// 			}

// 			if(effect == "condition_inflict")
// 			{
// 				inflictActorAffliction(actor, digestionsBuffs[digestionBuff][liked_disliked_neutral][effect], false);
// 			}

// 			if(effect == "healing")
// 			{
// 				healActor(actor, digestionsBuffs[digestionBuff][liked_disliked_neutral][effect]);
// 			}

// 			if(effect == "healing_fraction")
// 			{
// 				healActorPercent(actor, Number(1/digestionsBuffs[digestionBuff][liked_disliked_neutral][effect]));
// 			}
// 		}
// 	}
...
// 	// 		if(!silent)
// 	// 		{
// 	// 			chatMessage(actor, actor.name + ' was cured of '+ affliction_name +'!');
// 	// 		}
